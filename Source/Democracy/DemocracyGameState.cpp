    ...
    const FDifficultyProfile& DifficultyProfile)
{
    ...
    State.RtsWorld.CityBase.Buildings = {
        ...
        { TEXT("barracks"), TEXT("Defense Barracks"), TEXT("Military"), TEXT("Readiness"), TEXT("Candidate: RTS_Modern_Combat_Vehicle_Pack_Free-f9509a39 plus Concrete_Road_Barrier-6428e9ae for interim staging/defense visuals"), 1, 75, 120, 2, 0, 28, true, false, TEXT("Operational"), { TEXT("Government Command Center") }, { TEXT("military"), TEXT("defense") } },
        ...
        { TEXT("defense_post"), TEXT("Perimeter Defense Post"), TEXT("Defense"), TEXT("Security"), TEXT("Candidate: RTS_Modern_Combat_Vehicle_Pack_Free-f9509a39 or Concrete_Road_Barrier-6428e9ae for interim defensive visuals"), 1, 65, 115, 2, 0, 32, true, false, TEXT("Operational"), { TEXT("Defense Barracks") }, { TEXT("defense"), TEXT("border") } }
    };
    ...
    State.RtsWorld.UnitCatalog = {
        { TEXT("infantry_security_team"), TEXT("Security Infantry Team"), TEXT("Infantry"), TEXT("General-purpose ground control and building defense."), TEXT("barracks"), TEXT("Candidate: Arctic_Military_Soldier, Middle_Eastern_Armed_Fighter, or Naval_Tactical_Soldier packs for infantry visuals"), 25, 1, 1, 12, 10, 4, 1, 0, 2, true, false, { TEXT("Defense Barracks") }, { TEXT("infantry"), TEXT("ground"), TEXT("capture") } },
        { TEXT("vehicle_patrol_unit"), TEXT("Patrol Vehicle Unit"), TEXT("Vehicles"), TEXT("Fast ground response for border defense and patrols."), TEXT("barracks"), TEXT("Candidate: RTS_Modern_Combat_Vehicle_Pack_Free-f9509a39"), 65, 2, 2, 22, 18, 8, 2, 0, 3, true, false, { TEXT("Defense Barracks"), TEXT("Fuel Depot") }, { TEXT("vehicle"), TEXT("ground"), TEXT("rapid-response") } },
        ...
        { TEXT("logistics_convoy"), TEXT("Logistics Convoy"), TEXT("Logistics/Supply"), TEXT("Moves supplies, restores supply routes, and supports deployed forces."), TEXT("warehouse"), TEXT("Candidate: Vehicle_Variety_Pack_Volume_2-591e3b3f logistics trucks"), 55, 2, 2, 4, 14, 6, 1, 18, 1, true, false, { TEXT("Strategic Warehouse"), TEXT("Fuel Depot") }, { TEXT("supply"), TEXT("logistics"), TEXT("support") } },
        { TEXT("scout_team"), TEXT("Scout Team"), TEXT("Scouts"), TEXT("Low-cost reconnaissance, border warning, and map discovery."), TEXT("barracks"), TEXT("Candidate: Tactical_Crowd_AI_Toolkit scout marker behavior plus soldier packs for scout visuals"), 20, 1, 1, 6, 8, 7, 1, 0, 10, true, false, { TEXT("Defense Barracks") }, { TEXT("scout"), TEXT("recon"), TEXT("early-warning") } },
        { TEXT("static_defense_battery"), TEXT("Static Defense Battery"), TEXT("Defensive Units"), TEXT("Base and province defensive firepower; cannot be used for offensive pushes."), TEXT("defense_post"), TEXT("Candidate: RTS_Modern_Combat_Vehicle_Pack_Free-f9509a39 or Concrete_Road_Barrier-6428e9ae until final turret asset"), 80, 2, 2, 24, 34, 0, 4, 0, 0, true, true, { TEXT("Perimeter Defense Post") }, { TEXT("defense"), TEXT("static"), TEXT("anti-invasion") } }
    };
