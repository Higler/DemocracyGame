    ...
    int32 PlayerMapCountryIndex)
{
    ...
    State.RtsWorld.CityBase.Buildings = {
        ...
        { TEXT("defense_post"), TEXT("Perimeter Defense Post"), TEXT("Defense"), TEXT("Security"), TEXT("Imported vehicle candidates: /Game/RTS/Imported/Vehicles/ATV_N1_LE, /Game/RTS/Imported/Vehicles/FA_N26_LE, /Game/RTS/Imported/Vehicles/MSH_N2_LE. Still needs final defensive structure/turret asset."), 1, 65, 115, 2, 0, 32, true, false, TEXT("Operational"), { TEXT("Defense Barracks") }, { TEXT("defense"), TEXT("border") } }
    };
