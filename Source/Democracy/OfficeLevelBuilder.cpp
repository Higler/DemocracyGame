...
void AOfficeLevelBuilder::BuildOffice()
{
    ...
    if (UWorld* World = GetWorld())
    {
        ...
        if (AmbientLight && AmbientLight->GetLightComponent())
        {
            ...
            AmbientLight->GetLightComponent()->SetIntensity(2.0f);
        }
        ...
        if (CeilingLight && CeilingLight->PointLightComponent)
        {
            ...
            CeilingLight->PointLightComponent->SetIntensity(12000.0f);
        ...
        if (DeskLight && DeskLight->PointLightComponent)
        {
            ...
            DeskLight->PointLightComponent->SetIntensity(5200.0f);
        ...
        if (FrontFillLight && FrontFillLight->PointLightComponent)
        {
            ...
            FrontFillLight->PointLightComponent->SetIntensity(4200.0f);
        ...
        if (BackWallLight && BackWallLight->PointLightComponent)
        {
            ...
            BackWallLight->PointLightComponent->SetIntensity(3600.0f);
    ...
    SpawnAssetMesh(TEXT("Office Picture Left"), TEXT("/Game/Museum/Meshes/SM_Picture01.SM_Picture01"), FVector(-720.0f, 670.0f, 210.0f), FRotator(0.0f, 0.0f, 0.0f), FVector(1.0f, 1.0f, 1.0f), false);
    SpawnAssetMesh(TEXT("Office Picture Right"), TEXT("/Game/Museum/Meshes/SM_Picture02.SM_Picture02"), FVector(520.0f, 670.0f, 210.0f), FRotator(0.0f, 0.0f, 0.0f), FVector(1.0f, 1.0f, 1.0f), false);
    SpawnAssetMesh(TEXT("Office Oval Painting"), TEXT("/Game/Museum/Meshes/SM_OvalPainting.SM_OvalPainting"), FVector(-40.0f, 668.0f, 265.0f), FRotator(0.0f, 0.0f, 0.0f), FVector(0.9f, 0.9f, 0.9f), false);
    SpawnBox(TEXT("Visible Painting Frame Center"), FVector(0.0f, 682.0f, 285.0f), FVector(1.45f, 0.035f, 1.05f), FLinearColor(0.11f, 0.065f, 0.025f), false);
    SpawnBox(TEXT("Visible Painting Canvas Center"), FVector(0.0f, 678.0f, 285.0f), FVector(1.15f, 0.025f, 0.78f), FLinearColor(0.42f, 0.36f, 0.28f), false);
    SpawnBox(TEXT("Visible Painting Frame Left Wall"), FVector(-890.0f, -170.0f, 230.0f), FVector(0.035f, 1.15f, 0.95f), FLinearColor(0.11f, 0.065f, 0.025f), false);
    SpawnBox(TEXT("Visible Painting Canvas Left Wall"), FVector(-884.0f, -170.0f, 230.0f), FVector(0.025f, 0.86f, 0.68f), FLinearColor(0.26f, 0.34f, 0.38f), false);
    SpawnBox(TEXT("Visible Painting Frame Right Wall"), FVector(890.0f, -170.0f, 230.0f), FVector(0.035f, 1.15f, 0.95f), FLinearColor(0.11f, 0.065f, 0.025f), false);
    SpawnBox(TEXT("Visible Painting Canvas Right Wall"), FVector(884.0f, -170.0f, 230.0f), FVector(0.025f, 0.86f, 0.68f), FLinearColor(0.36f, 0.28f, 0.22f), false);
    ...
    if (!SpawnAssetMesh(TEXT("Executive Office Chair"), TEXT("/Game/DemocracyOffice/Props/ExecutiveChair/executive_office_chair1.executive_office_chair1"), FVector(0.0f, 435.0f, 0.0f), FRotator(0.0f, 180.0f, 0.0f), FVector(1.15f, 1.15f, 1.15f)) && !SpawnAssetMesh(TEXT("Office Chair Mesh"), TEXT("/Game/Museum/Meshes/SM_Chair_01.SM_Chair_01"), FVector(0.0f, 435.0f, 0.0f), FRotator(0.0f, 180.0f, 0.0f), FVector(1.35f, 1.35f, 1.35f)))
    {
        SpawnBox(TEXT("Chair Back"), FVector(0.0f, 455.0f, 115.0f), FVector(1.15f, 0.22f, 1.35f), FLinearColor(0.02f, 0.021f, 0.024f));
        SpawnBox(TEXT("Chair Seat"), FVector(0.0f, 410.0f, 25.0f), FVector(1.05f, 0.85f, 0.25f), FLinearColor(0.025f, 0.026f, 0.030f));
    }
    ...
    SpawnInteractableTarget(TEXT("BriefingFolder"), TEXT("Open the briefing."), FVector(-108.0f, 270.0f, DeskSurfaceZ + 60.0f), FVector(1.45f, 1.20f, 1.05f));
    ...
    SpawnInteractableTarget(TEXT("Lamp"), TEXT("Toggle desk lamp."), FVector(-185.0f, 228.0f, DeskSurfaceZ + 94.0f), FVector(1.4f, 1.4f, 1.8f));
    ...
    SpawnInteractableTarget(TEXT("Computer"), TEXT("Open national dashboard."), FVector(0.0f, 350.0f, DeskSurfaceZ + 58.0f), FVector(2.0f, 1.7f, 1.7f));
    ...
    SpawnInteractableTarget(TEXT("Phone"), TEXT("Open advisor warnings."), FVector(155.0f, 245.0f, DeskSurfaceZ + 58.0f), FVector(2.35f, 2.05f, 1.75f));
    ...
    // Shelves and room dressing.
    SpawnBox(TEXT("Bookcase"), FVector(-730.0f, -585.0f, 105.0f), FVector(1.15f, 0.45f, 2.1f), FLinearColor(0.12f, 0.065f, 0.03f));
    SpawnBox(TEXT("Side Cabinet"), FVector(700.0f, -585.0f, 38.0f), FVector(1.05f, 0.45f, 0.76f), FLinearColor(0.13f, 0.07f, 0.035f));
    SpawnAssetMesh(TEXT("Wooden Monkey Statue"), TEXT("/Game/DemocracyOffice/Props/WoodenMonkey/monkey.monkey"), FVector(700.0f, -585.0f, 88.0f), FRotator(0.0f, -35.0f, 0.0f), FVector(0.18f, 0.18f, 0.18f), false);
    ...
    SpawnBox(TEXT("Meeting Room Front Wall Left"), FVector(-970.0f, -2610.0f, 160.0f), FVector(7.0f, 0.14f, 3.2f), FLinearColor(0.32f, 0.31f, 0.29f));
    SpawnBox(TEXT("Meeting Room Front Wall Right"), FVector(-70.0f, -2610.0f, 160.0f), FVector(7.0f, 0.14f, 3.2f), FLinearColor(0.32f, 0.31f, 0.29f));
    ...
    SpawnAssetMesh(TEXT("Conference Table Line002"), TEXT("/Game/DemocracyOffice/Props/MeetingRoom/ConferenceTableChairs/Line002.Line002"), MeetingTableOrigin, FRotator::ZeroRotator, MeetingFurnitureScale, false);
    SpawnAssetMesh(TEXT("Conference Table Line003"), TEXT("/Game/DemocracyOffice/Props/MeetingRoom/ConferenceTableChairs/Line003.Line003"), MeetingTableOrigin, FRotator::ZeroRotator, MeetingFurnitureScale, false);
    SpawnAssetMesh(TEXT("Conference Table Line005"), TEXT("/Game/DemocracyOffice/Props/MeetingRoom/ConferenceTableChairs/Line005.Line005"), MeetingTableOrigin, FRotator::ZeroRotator, MeetingFurnitureScale, false);
    SpawnAssetMesh(TEXT("Conference Table Line006"), TEXT("/Game/DemocracyOffice/Props/MeetingRoom/ConferenceTableChairs/Line006.Line006"), MeetingTableOrigin, FRotator::ZeroRotator, MeetingFurnitureScale, false);
    ...
    SpawnAssetMesh(TEXT("Meeting Room Phone"), TEXT("/Game/DemocracyOffice/Props/Phone/nt_vis200_01/StaticMeshes/nt_vis200_01.nt_vis200_01"), FVector(-430.0f, -3380.0f, MeetingTableSurfaceZ - 10.0f), FRotator(0.0f, -25.0f, 0.0f), FVector(1.0f, 1.0f, 1.0f), false);
    SpawnAssetMesh(TEXT("Meeting Desk Outlet"), TEXT("/Game/DemocracyOffice/Props/MeetingRoom/DeskOutlet/deskoutlet_quads.deskoutlet_quads"), FVector(-610.0f, -3385.0f, MeetingTableSurfaceZ - 4.0f), FRotator(0.0f, 15.0f, 0.0f), FVector(0.55f, 0.55f, 0.55f), false);
    SpawnBox(TEXT("Resource Manager Placard"), FVector(-850.0f, -3820.0f, MeetingTableSurfaceZ + 2.0f), FVector(0.44f, 0.16f, 0.08f), FLinearColor(0.12f, 0.35f, 0.16f), false);
    SpawnInteractableTarget(TEXT("MeetingAdvisor_Resources"), TEXT("Meet with the resource manager."), FVector(-850.0f, -3820.0f, 145.0f), FVector(1.25f, 1.05f, 1.75f));
    SpawnBox(TEXT("Military Advisor Placard"), FVector(-630.0f, -3820.0f, MeetingTableSurfaceZ + 2.0f), FVector(0.44f, 0.16f, 0.08f), FLinearColor(0.36f, 0.10f, 0.09f), false);
    SpawnInteractableTarget(TEXT("MeetingAdvisor_Military"), TEXT("Meet with the military advisor."), FVector(-630.0f, -3820.0f, 145.0f), FVector(1.25f, 1.05f, 1.75f));
    SpawnBox(TEXT("Social Advisor Placard"), FVector(-410.0f, -3820.0f, MeetingTableSurfaceZ + 2.0f), FVector(0.44f, 0.16f, 0.08f), FLinearColor(0.12f, 0.22f, 0.48f), false);
    SpawnInteractableTarget(TEXT("MeetingAdvisor_Social"), TEXT("Meet with the social advisor."), FVector(-410.0f, -3820.0f, 145.0f), FVector(1.25f, 1.05f, 1.75f));
    SpawnBox(TEXT("Economic Advisor Placard"), FVector(-190.0f, -3820.0f, MeetingTableSurfaceZ + 2.0f), FVector(0.44f, 0.16f, 0.08f), FLinearColor(0.58f, 0.42f, 0.10f), false);
    SpawnInteractableTarget(TEXT("MeetingAdvisor_Economy"), TEXT("Meet with the economic advisor."), FVector(-190.0f, -3820.0f, 145.0f), FVector(1.25f, 1.05f, 1.75f));
    SpawnBox(TEXT("Diplomacy Advisor Placard"), FVector(-850.0f, -3040.0f, MeetingTableSurfaceZ + 2.0f), FVector(0.44f, 0.16f, 0.08f), FLinearColor(0.38f, 0.18f, 0.45f), false);
    SpawnInteractableTarget(TEXT("MeetingAdvisor_Diplomacy"), TEXT("Meet with the diplomacy advisor."), FVector(-850.0f, -3040.0f, 145.0f), FVector(1.25f, 1.05f, 1.75f));
    SpawnBox(TEXT("Infrastructure Advisor Placard"), FVector(-630.0f, -3040.0f, MeetingTableSurfaceZ + 2.0f), FVector(0.44f, 0.16f, 0.08f), FLinearColor(0.38f, 0.32f, 0.24f), false);
    SpawnInteractableTarget(TEXT("MeetingAdvisor_Infrastructure"), TEXT("Meet with the infrastructure advisor."), FVector(-630.0f, -3040.0f, 145.0f), FVector(1.25f, 1.05f, 1.75f));
    SpawnBox(TEXT("Security Advisor Placard"), FVector(-410.0f, -3040.0f, MeetingTableSurfaceZ + 2.0f), FVector(0.44f, 0.16f, 0.08f), FLinearColor(0.08f, 0.08f, 0.10f), false);
    SpawnInteractableTarget(TEXT("MeetingAdvisor_Intelligence"), TEXT("Meet with the security advisor."), FVector(-410.0f, -3040.0f, 145.0f), FVector(1.25f, 1.05f, 1.75f));
    SpawnBox(TEXT("Public Welfare Advisor Placard"), FVector(-190.0f, -3040.0f, MeetingTableSurfaceZ + 2.0f), FVector(0.44f, 0.16f, 0.08f), FLinearColor(0.12f, 0.45f, 0.42f), false);
    SpawnInteractableTarget(TEXT("MeetingAdvisor_Welfare"), TEXT("Meet with the public welfare advisor."), FVector(-190.0f, -3040.0f, 145.0f), FVector(1.25f, 1.05f, 1.75f));
    ...
    SpawnBox(TEXT("Press Room Front Wall Left"), FVector(1225.0f, -2580.0f, 160.0f), FVector(6.9f, 0.14f, 3.2f), FLinearColor(0.31f, 0.30f, 0.28f));
    SpawnBox(TEXT("Press Room Front Wall Right"), FVector(2135.0f, -2580.0f, 160.0f), FVector(6.9f, 0.14f, 3.2f), FLinearColor(0.31f, 0.30f, 0.28f));
    ...
    SpawnBox(TEXT("Press Stage"), FVector(1680.0f, -2860.0f, 18.0f), FVector(8.6f, 2.8f, 0.36f), FLinearColor(0.14f, 0.075f, 0.035f));
    SpawnBox(TEXT("Press Podium Base"), FVector(1680.0f, -2980.0f, 42.0f), FVector(0.72f, 0.52f, 0.84f), FLinearColor(0.16f, 0.085f, 0.035f));
    SpawnBox(TEXT("Press Podium Top"), FVector(1680.0f, -2970.0f, 91.0f), FVector(0.92f, 0.62f, 0.16f), FLinearColor(0.20f, 0.11f, 0.045f));
    SpawnBox(TEXT("Press Podium Mic Left"), FVector(1654.0f, -2945.0f, 112.0f), FVector(0.035f, 0.035f, 0.35f), FLinearColor(0.02f, 0.02f, 0.02f), false);
    SpawnBox(TEXT("Press Podium Mic Right"), FVector(1706.0f, -2945.0f, 112.0f), FVector(0.035f, 0.035f, 0.35f), FLinearColor(0.02f, 0.02f, 0.02f), false);
    SpawnInteractableTarget(TEXT("PressPodium"), TEXT("Make a press announcement."), FVector(1680.0f, -2970.0f, 130.0f), FVector(1.7f, 1.4f, 2.1f));

    const float PressChairXOffsets[6] = { -330.0f, -220.0f, -110.0f, 110.0f, 220.0f, 330.0f };
    for (int32 RowIndex = 0; RowIndex < 5; ++RowIndex)
    {
        const float ChairY = -3340.0f - static_cast<float>(RowIndex) * 145.0f;
    ...
    if (UWorld* World = GetWorld())
    {
        ...
        APointLight* PressRoomLight = World->SpawnActor<APointLight>(APointLight::StaticClass(), FVector(1680.0f, -3480.0f, 245.0f), FRotator::ZeroRotator);
        if (PressRoomLight && PressRoomLight->PointLightComponent)
        {
            PressRoomLight->SetActorLabel(TEXT("Press Room Light"));
            PressRoomLight->PointLightComponent->SetMobility(EComponentMobility::Movable);
            PressRoomLight->PointLightComponent->SetIntensity(9500.0f);
            PressRoomLight->PointLightComponent->SetAttenuationRadius(1600.0f);
        }


        APointLight* MeetingRoomLight = World->SpawnActor<APointLight>(APointLight::StaticClass(), FVector(-520.0f, -3430.0f, 245.0f), FRotator::ZeroRotator);
        if (MeetingRoomLight && MeetingRoomLight->PointLightComponent)
        {
            MeetingRoomLight->SetActorLabel(TEXT("Meeting Room Light"));
            MeetingRoomLight->PointLightComponent->SetMobility(EComponentMobility::Movable);
            MeetingRoomLight->PointLightComponent->SetIntensity(9000.0f);
            MeetingRoomLight->PointLightComponent->SetAttenuationRadius(1500.0f);
        }
    }
